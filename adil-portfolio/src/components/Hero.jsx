        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-10 w-full relative top-4 md:top-6 lg:top-8">
          <div className="flex-1 flex flex-col items-start gap-4">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
              {NAME}
              <span className="block text-orange-500 text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-2">{TAGLINE}</span>
            </h1>
            <span className="inline-flex items-center gap-2 rounded-full border border-orange-300 bg-white px-3 py-1 sm:px-4 sm:py-1.5 text-sm text-slate-700">
              <span className="h-2 w-2 rounded-full bg-orange-500" />
              Available for internships and collabs
            </span>
            <p className="max-w-2xl text-slate-700 text-base sm:text-lg md:text-xl">{SUMMARY}</p>
          ...
          <div className="md:flex-shrink-0 self-start md:self-center">
            <img
              ...
              className="h-28 w-28 sm:h-36 sm:w-36 md:h-[12rem] md:w-[12rem] lg:h-[16rem] lg:w-[16rem] rounded-full ring-2 ring-orange-200 object-cover shadow-md"
              loading="eager"
              decoding="async"
              fetchpriority="high"
            />
